    ...
    public HashMap<String, Integer> Stemmer(HashMap<String, Integer> listOfTerms) {
        ...
        for (String termBeforeStemming : listOfTerms.keySet()) {
            if (!(termBeforeStemming.charAt(0) >= '0' && termBeforeStemming.charAt(0) <= '9')) {
                ...
                listOfTermsAfterStemming.put(termBeforeStemming, listOfTerms.get(termBeforeStemming));
            }
        }
        return listOfTermsAfterStemming;
    }


    /**
     * do stemming for the word
     *
     * @param word -.
